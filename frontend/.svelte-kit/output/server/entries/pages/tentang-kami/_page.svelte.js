...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `<!-- HEAD_svelte-9ps8yp_START -->${$$result.title = `<title>Tentang Kami - ${escape($siteName)}</title>`, ""}<meta name="description" content="Informasi tentang sejarah, visi, misi, fasilitas, dan kontak sekolah kami."><style data-svelte-h="svelte-q6ofa5">.prose ul {
      padding-left: 1.5rem;
      margin: 0.5rem 0;
